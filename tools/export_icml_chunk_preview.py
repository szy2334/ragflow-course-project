"""Export compact human-reviewable records from candidate ICML JSONL files."""
...
def main() -> int:
    ...
    records = []
    for mode in ("shared", "camera_ready", "initial_submission"):
        source = args.source_dir / f"icml_2026_{mode}.jsonl"
