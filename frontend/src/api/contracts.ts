...
export type RouteType = 'fact' | 'explain' | 'follow_up' | 'general_chat' | 'out_of_scope'
...
export interface FormatReviewHistoryItem { format_review_id: string; paper_id: string; format_profile: Pick<FormatProfileView, 'format_profile_id' | 'profile_key' | 'name' | 'version'>; submission_mode: string; status: TaskStatus; created_at: string; completed_at: string | null }
