...
const neuripsFormatProfile: FormatProfileView = { format_profile_id: 'bd7aa26a-df6f-4314-8752-cfcbed6ea096', profile_key: 'neurips_2026', venue_id: 'neurips', name: 'NeurIPS 2026 投稿格式', version: '2026.1', description: '由服务端绑定 NeurIPS 2026 格式规范库。', allowed_submission_modes: ['initial_submission', 'camera_ready'], is_active: true, created_at: now, updated_at: now }
const degreeFormatProfile: FormatProfileView = { format_profile_id: 'f9f4d714-557e-41e3-8edf-9bc3c295ec98', profile_key: 'degree_thesis_2026', venue_id: 'degree-thesis', name: '学位论文格式（2026）', version: '2026.1', description: '由服务端绑定学位论文格式规范库。', allowed_submission_modes: ['initial_submission'], is_active: true, created_at: now, updated_at: now }
const formatReview = (): FormatReviewView => ({ format_review_id: 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', paper_id: papers[0].paper_id, format_profile: { format_profile_id: neuripsFormatProfile.format_profile_id, profile_key: neuripsFormatProfile.profile_key, name: neuripsFormatProfile.name, version: neuripsFormatProfile.version }, submission_mode: 'initial_submission', selected_rule_ids: [], status: 'succeeded', summary_markdown: '## 格式审查摘要\n\n已基于完整适用规范完成综合核对。', coverage_report: { covered_categories: ['heading', 'body', 'reference'], missing_categories: ['figure'] }, synthesis_status: 'completed', units: [{ unit_id: 'u-001', unit_position: 0, unit_kind: 'front_matter', title: '标题与投稿信息', page_range: [1, 1], status: 'validated', expected_rule_ids: ['heading:title-size'], retrieved_rule_ids: ['heading:title-size'], not_applicable_rule_ids: [], coverage: { complete: true }, unit_cycle_count: 1, retry_budget_remaining: 1, last_retry_reason: null, event_sequence: 3, findings: [] }], annotations: { items: [] }, items: [{ unit_id: 'u-001', unit_position: 0, source_stage: 'final', rule_id: 'heading:title-size', rule_title: '论文标题字号', category: 'heading', aspect: '论文标题字号', result: 'non_compliant', severity: 'medium', evidence_status: 'complete', finding: '第 1 页标题字号与所选规范不一致。', suggestion: '按规范调整标题字号与加粗样式。', page_numbers: [1], paper_evidences: [{ page_number: 1, bbox: [72, 96, 420, 122], quote: 'Evidence-Aware Scientific Reading' }], standard_evidences: [{ quote: 'The paper title should be set in 14 point bold type.' }], annotation: { page: 1, bbox: [72, 96, 420, 122] } }, { rule_id: 'figure:coverage', rule_title: '图表格式要求', category: 'figure', aspect: '图表格式要求', result: 'unverifiable', severity: 'info', evidence_status: 'incomplete', finding: '未能完整检索图表类适用规范，系统未作合规推断。', suggestion: null, page_numbers: [], paper_evidences: [], standard_evidences: [], annotation: {} }], error: null, created_at: now, completed_at: now })
