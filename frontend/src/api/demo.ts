...
const answer: AnswerView = { message_id: '56565656-5656-4656-8656-565656565656', session_id: session.session_id, task_id: '33333333-3333-4333-8333-333333333333', answer: '## 核心结论\n\n该方法通过把检索、分析和证据核验放入同一工作流，减少了不可追溯的结论。\n\n在主要数据集上，Evidence F1 提升 **4.2 个点**。\n\n该结论已由实验章节原文支持。', claims: [claim], evidences: [evidence], confidence: 0.84, is_refusal: false, refusal_reason: null, warnings: [], completed_at: '2026-07-17T08:20:30Z' }
const accepted = (task_id: string, resource_id: string | null = null): TaskAccepted => ({ task_id, status: 'pending', status_url: `/api/v1/tasks/${task_id}`, stream_url: `/api/v1/workflows/${task_id}/events`, resource_id })
