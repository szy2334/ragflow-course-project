...
<template>
  <section class="page paper-detail">
    ...
    <template v-else-if="paper">
      ...
      <section v-if="paper.summary_markdown" class="analysis-section"><div class="section-heading"><div><p class="eyebrow">论文理解</p><h2>论文摘要</h2></div></div><MarkdownContent :content="paper.summary_markdown" /></section>
