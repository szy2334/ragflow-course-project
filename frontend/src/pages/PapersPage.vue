...
<template>
  <section class="page page-papers">
    ...
    <div class="toolbar">
      ...
      <select v-model="selectedStatus" aria-label="按状态筛选" @change="load"><option value="">全部状态</option><option value="ready">可阅读</option><option value="parsing">解析中</option><option value="indexing">索引中</option><option value="failed">失败</option></select>
